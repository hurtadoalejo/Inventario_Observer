...
public class InventarioAppViewController {
    ...
    void initialize() throws IOException {
        ...
        FXMLLoader notificacionInventarioDosLoader = new FXMLLoader(getClass().getResource("/co/edu/uniquindio/inventario/inventarioapp/InventarioDos.fxml"));
        tab_NotificacionInventarioDos.setContent(notificacionInventarioDosLoader.load());
        NotificacionInventarioDosViewController notificacionInventarioDosViewController = notificacionInventarioDosLoader.getController();
